...
import WhatsAppButtonGreenSmall from './WhatsAppButtonGreenSmall.png';
          ...
          <div class="row" id="rowone">
            ...
            <div class="col-3	col-sm-3	col-md-3	col-lg-3	col-xl-3">
              ...
              <div class="row" id="col-3-row-1">
                ...
                <div class="col">
                  <button type="button" class="btn btn-primary" onClick={handleClick} id="bookmark-button">Bookmark</button>
                  <br></br><br></br><br></br>

                  <a aria-label="Chat on WhatsApp" href="https://wa.me/+254722764008"> <img id="property-whatsapp-iage" alt="Chat on WhatsApp" src={WhatsAppButtonGreenSmall} /></a>
